...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton = QtWidgets.QPushButton(self.centralwidget,clicked= lambda:self.inicio())
        ...
        self.menuCargar.triggered.connect(lambda :CargarArchivo())
    ...
    def inicio(self):
        self.plainTextEdit_2.setPlainText(requests.get(url).text)
